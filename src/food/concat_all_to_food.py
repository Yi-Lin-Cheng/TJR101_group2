...
def main():
    data1 = pd.read_csv(base_file, encoding="utf-8", engine="python")
    data2 = pd.read_csv(cafe_file, encoding="utf-8", engine="python")
    data3 = pd.read_csv(taipei_file, encoding="utf-8", engine="python")
