...
if Path("/opt/airflow/data").exists():
    data_dir = Path("/opt/airflow/data/restaurant")
else:
    data_dir = Path("data/restaurant")
new_file = data_dir / "restaurant04_compare_name_and_add_new.csv"
update_target_file = data_dir / "restaurant05_extract_googlemap.csv"
progress_file = data_dir / "restaurant05_extract_googlemap_progress.csv"
err_log_file = data_dir / "restaurant05_extract_googlemap_err_log.txt"
